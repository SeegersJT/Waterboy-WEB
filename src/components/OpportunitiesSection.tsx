      ...
      <div className="container-custom">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="section-subheading">
            Join the WaterBoy family and start your own successful water delivery business
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-waterboy-500 to-waterboy-700 rounded-2xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-8 md:p-12 flex flex-col justify-center text-white">
              ...
              <p className="mb-6">
                Do you want to work from home and earn a very good income? The WaterBoy offers licensed 
                opportunities all over South Africa.
              </p>
        ...
        <div className="mt-12 bg-waterboy-50 rounded-xl p-8">
          <h3 className="text-xl font-bold text-waterboy-700 mb-4">How It Works</h3>
          <p className="text-gray-700 mb-6">
            WaterBoy would like to give you the opportunity to benefit from our business model by giving 
            other potential WaterBoys the opportunity to start their own WaterBoy business.
          </p>
          <p className="text-gray-700 mb-6">
            Contact our Head-Office and talk to Leon for more person-to-person information about this 
            exciting opportunity.
          </p>
          <div className="flex justify-center">
            <Button className="bg-waterboy-600 hover:bg-waterboy-700">
              <a href="mailto:info@waterboy.co.za">Request More Information</a>
            </Button>
          </div>
        </div>
      </div>
