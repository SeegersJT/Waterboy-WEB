      ...
      <div className="container-custom">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="section-subheading">
            Get in touch with our team for orders, inquiries, or more
            information
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-waterboy-700">
                Send Us A Message
              </CardTitle>
            </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="Home Delivery">
                      Container Rental & Delivery
                    </option>
                    <option value="Office Delivery">Water Cooler Rental</option>
                    <option value="Water Cooler Rental">
                      Refills & Coupons
                    </option>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-waterboy-700 mb-4">
                Get In Touch
              </h3>
              <p className="text-gray-700 mb-6">
                Have questions about our services or want to schedule a
                delivery? Contact us using any of the methods below and our
                friendly team will be happy to assist you.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="bg-waterboy-100 p-3 rounded-full mr-4">
                    <svg
                      className="h-6 w-6 text-waterboy-600"
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:water8boy@gmail.com"
                      className="text-lg font-medium text-waterboy-700 hover:underline"
                    >
                      water8boy@gmail.com
                    </a>
            ...
            <div>
              <h3 className="text-xl font-bold text-waterboy-700 mb-4">
                Business Hours
              </h3>
