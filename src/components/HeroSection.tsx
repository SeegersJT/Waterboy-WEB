      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-8 animate-fade-up">
            WaterBoy delivers pure, fresh good tasting water straight to your
            home or office on a weekly basis. No more heavy containers to carry!
          </p>
          <div
            className="flex flex-col md:flex-row gap-4 animate-fade-up"
